  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      if (result.user.role === 'coordinator') {
        ...
        setError('Invalid role. This login is specifically for Coordinators.')
      }
    } catch (err) {
      ...
      <div className="relative max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <Text className="text-red-100 text-lg font-light">
            Asset coordination and <span className="text-red-300 font-semibold">team management</span> portal
          </Text>
        </div>
        ...
        >
          ...
          >
            ...
            <Form.Item>
              ...
              >
                {loading ? 'Authenticating...' : 'Access Coordinator Portal'}
              </Button>
            </Form.Item>
          </Form>
              ...
              <div className="grid grid-cols-1 gap-2 mt-4">
                <div className="flex items-center space-x-3">
                  ...
                  <Text className="text-gray-700 font-medium">
                    Asset Assignment & Distribution
                  </Text>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                  <Text className="text-gray-700 font-medium">
                    Requisition Processing & Approval
                  </Text>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full"></div>
