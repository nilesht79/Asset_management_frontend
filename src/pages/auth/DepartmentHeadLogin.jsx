...
import { UserOutlined, LockOutlined, SettingOutlined, ArrowLeftOutlined } from '@ant-design/icons'
...
const DepartmentHeadLogin = () => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      if (result.user.role === 'department_head') {
        navigate('/dashboard')
      } else {
        setError('Invalid role. This login is specifically for Department Heads.')
      }
    } catch (err) {
        ...
        <div className="text-center mb-8">
          ...
          <div className="mb-6">
            <div className="w-20 h-20 mx-auto bg-gradient-to-br from-red-500 to-red-700 rounded-3xl flex items-center justify-center shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
              <SettingOutlined className="text-4xl text-white" style={{ filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.3))' }} />
            </div>
          </div>
          ...
          <Text className="text-red-100 text-lg font-light">
            Strategic oversight and <span className="text-red-300 font-semibold">executive</span> operations
          </Text>
        </div>
        ...
        >
          ...
          >
            ...
            <Form.Item>
              ...
              >
                {loading ? 'Authenticating...' : 'Access Executive Portal'}
              </Button>
            </Form.Item>
          </Form>
              ...
              <div className="grid grid-cols-1 gap-2 mt-4">
                <div className="flex items-center space-x-3">
                  ...
                  <Text className="text-gray-700 font-medium">
                    Strategic Requisition Approvals
                  </Text>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                  <Text className="text-gray-700 font-medium">
                    Departmental Asset Portfolio
                  </Text>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-red-500 rounded-full"></div>
        ...
        <div className="text-center mt-8">
          <div className="p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            <Text className="text-red-200 font-medium">
              Executive access portal • Need assistance? Contact your 
